...
// needed a mock for testing buttons
...
import AccessibilityUtil from "../../../node_modules/react-native-web/dist/components/Touchable/../../modules/AccessibilityUtil";
import BoundingDimensions from "../../../node_modules/react-native-web/dist/components/Touchable/BoundingDimensions";
import findNodeHandle from "../../../node_modules/react-native-web/dist/components/Touchable/../../modules/findNodeHandle";
import normalizeColor from "../../../node_modules/normalize-css-color";
import Position from "../../../node_modules/react-native-web/dist/components/Touchable/Position";
import React from "../../../node_modules/react";
import TouchEventUtils from "../../../node_modules/fbjs/lib/TouchEventUtils";
import UIManager from "../../../node_modules/react-native-web/dist/components/Touchable/../../apis/UIManager";
import View from "../../../node_modules/react-native-web/dist/components/Touchable/../../components/View";
...
const TouchableMixin = {
  componentDidMount() {
    ...
    // console.log('------------USING MOCK TOUCHABLE-----------------------');
   ...
   */
  touchableHandleResponderGrant(e: Event) {
   ...
   */
  touchableHandleResponderRelease(e: Event) {
   ...
   */
  touchableHandleResponderTerminate(e: Event) {
   ...
   */
  touchableHandleResponderMove(e: Event) {
  ...
  _handleDelay(e: Event) {
    this.touchableDelayTimeout = null;
    this._receiveSignal(Signals.DELAY, e);
  },

  _handleLongDelay(e: Event) {
   ...
   * @sideeffects
   */
  _receiveSignal(signal: string, e: Event) {
  ...
  _startHighlight(e: Event) {
    this._savePressInLocation(e);
    this.touchableHandleActivePressIn && this.touchableHandleActivePressIn(e);
  },

  _endHighlight(e: Event) {
  ...
  touchableHandleKeyEvent(e: Event) {
    const ENTER = 13;
    const SPACE = 32;
    const {type, which} = e;
